...
public class pg33 {
	static ArrayList<pg33_OneRec> k37_ArrayOncRec = new ArrayList <pg33_OneRec>();
	...
	static final int k37_iPerson = 12;	// 총인원수
	static final int k37_pgPerson = 11;	//페이지당 인원수
	...
	public static void k37_dataSet() {	// 데이터 세팅 메소드
		for(int k37_i = 1; k37_i <= k37_iPerson; k37_i++) {	//총 인원수 만큼 도는 for문 작성
			...
			k37_ArrayOncRec.add(new pg33_OneRec(k37_i, k37_name, k37_kor, k37_eng, k37_mat));
		}
		// 총페이지 계산하는 if
