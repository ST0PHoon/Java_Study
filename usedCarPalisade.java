...
public class usedCarPalisade {
		...
		public static void main(String[] args) throws IOException {
			...
			driver.get(
					"http://wndrhckwhgkq.kr/buy/sub_list.php?cd_gubun=1&cd_brand=5&cd_model=42&cd_submodel=&cd_level=&pop_page=1&recom_page=1&s_st_price=&s_ed_price=&s_st_year=&s_ed_year=&s_cd_mileage=&e_cd_mileage=&s_mission=&s_fuel=&s_color=");

			String carName = driver
					.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div[1]/form/div[1]/ul/li[2]/div[2]/div[8]"))
					.getText();
			...
			for (int j = 0; j < 1; j++) {
				...
				for (int i = 1; i <= 30; i++) {
					...
					carType = driver
							...
							.getText();
					carType = carType.replace("_ µðÁ© ", "");
					carType = carType.replace("_ °¡¼Ö¸° ", "");
			...
			FileWriter fw = new FileWriter("C:\\Users\\Á¤ÁöÈÆ\\Desktop\\out2.csv", true);
