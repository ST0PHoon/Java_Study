...
public class usedCar {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int j = 0; j < 2; j++) {
			...
			for (int i = 1; i <= 30; i++) {
				...
				companyType = driver
						...
						.getText();
				companyType = companyType.replace("(대우)", "");
				...
				fuel = driver
						.findElement(By
								.xpath("/html/body/div[3]/div[2]/div/div/div[2]/div/div[" + i + "]/a/div[2]/dl[4]/dd"))
						.getText();
		...
		FileWriter fw = new FileWriter("C:\\Users\\정지훈\\Desktop\\out.csv",true);
